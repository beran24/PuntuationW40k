import { SecondaryMission } from '@/types/Rules';
...
export const secondaryMissions: SecondaryMission[] = [
  ...
  },
  {
    ...
    ruleDescription:
      'Fixed: 4VP per enemy CHARACTER destroyed. Tactical: 5VP if one or more CHARACTERs destroyed in a turn or all destroyed.',
  },
  {
    ...
    ruleDescription:
      '3VP if one unit (not AIRCRAFT or Battle-shocked) is in enemy deployment. 4VP if two or more.',
  },
  {
    id: 'bring_it_down',
    name: 'Bring it down',
  ...
  },
  {
    ...
    ruleDescription:
      '2VP if units in 3 table quarters (not near center). 4VP for 4 quarters.',
  },
  {
    id: 'establish_locus',
