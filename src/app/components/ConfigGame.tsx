    ...
    <main className="flex-1 flex w-full header justify-center text-white">
      <div className="flex flex-col gap-2">
        ...
        <Selector
          ...
          onHandleChange={(value) => changeGameConfig('battleSize', value)}
        />
        <Selector
          label="Select Deployment"
          options={deployments}
          value={game.deployment || deployments[0].id}
          onHandleChange={(value) => changeGameConfig('deployment', value)}
        />
        <Selector
          label="Select Mission Rule"
          options={missionRules}
          value={game.missionRule || missionRules[0].id}
          onHandleChange={(value) => changeGameConfig('missionRule', value)}
        />
        <Selector
